...
<html lang="ja">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# website: http://ogp.me/ns/website#">
    ...
    <meta name="description" content="ビジネスマナーから一般常識に至るまで様々なクイズを4択で出題するWEBアプリです">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:image" content="{{ url('') }}/images/header-logo.png">
    <meta name="twitter:url" content="{{ url()->full() }}">
    <meta name="twitter:description" content="ビジネスマナーから一般常識に至るまで様々なクイズを4択で出題するWEBアプリです">
    <meta name="twitter:title" content="4択クイズ&クイズ徹底解説">
    <meta property="og:description" content="4 Answers Quizとはビジネスマナーから一般常識に至るまで様々なクイズを4択で出題するWEBアプリです">
    <meta property="og:site_name" content="4択クイズ&クイズ徹底解説">
    ...
    <meta property="og:title" content="4択クイズ&クイズ徹底解説">
    <link href="/css/app.css" rel="stylesheet">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="api-token" content="{{ session()->get('api_token') ?? '' }}">
    <title>4択クイズに挑戦！</title>
  </head>
  <body>
    <div id="app">
